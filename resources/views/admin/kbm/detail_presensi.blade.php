    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <a href="/kbm/detail/{{$id_kelas}}" class="btn btn-warning btn-sm">
                ...
                <table id="example1" class="table table-bordered table-striped">
                    ...
                    <tr>
                        ...
                        <td>
                          <center>
                            <a href="/kbm/presensi/{{ $item->id }}" class="btn btn-info btn-sm">
